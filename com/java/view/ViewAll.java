...
//	}
	...
	public static void lineFavorite() {//노선 즐겨찾기
		...
		System.out.println();
		System.out.println();
		System.out.println("\t\t\t\t\t\t\t 1.즐겨 찾기 목록");
		System.out.println("\t\t\t\t\t\t\t 2.즐겨 찾기 편집");
		System.out.println("\t\t\t\t\t\t\t 3.뒤로 가기");
...
//	}
	...
	public static void statisticsChaosTwo() { // 혼잡도 2번째 라벨
		...
		System.out.println("\t\t\t\t\t (상행(외선) 또는 하행(내선) 기입)");
		System.out.println();
		System.out.println("====================================================================================");
...
//		System.out.println("\t\t 4. %s의 직급: %s\n"); //id와 직급 넣어주세요
	...
	public static void changeNoChairTrain() { // 역관리 >  열차 변경 > 변경 할 호선
		System.out.println("====================================================================================");
		System.out.println();
	...
	public static void trainAddTwo() { // 역 관리 >  열차 추가 > 추가 할 열차 수
		...
		System.out.printf ("\t\t\t\t\t (숫자로 입력해주세요) 남은 열차수: %d",StationManagement.spareTrain);
		System.out.println();
		System.out.println("====================================================================================");
	...
	public static void trainAddSix() { // 역 관리 > 열차 추가 > 요일 선택
		System.out.println("====================================================================================");
		System.out.println();
		System.out.println("\t\t\t\t\t 요일을 선택해주세요");
		System.out.println("\t\t\t\t\t (평일 또는 주말)");
	...
	public static void changeNoChairTrainResult() { // 역 관리 열차 추가의 혼잡도 결과물 
		System.out.println("====================================================================================");
		System.out.println();
