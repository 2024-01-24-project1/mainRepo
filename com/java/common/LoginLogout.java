...
public class LoginLogout {
	...
	public static void login() {
		...
		checkEmployee = Data.employeeList.stream()
				.anyMatch(employee -> employee.getId().equals(id) && employee.getPw().equals(pw));
	...
	public static void loginEmployee() { // 관리자 로그인 화면 
		System.out.println();
		System.out.println("=======================================");
		System.out.println();
	...
	public static void loginUser() { // 고객 로그인 화면 
		System.out.println();
